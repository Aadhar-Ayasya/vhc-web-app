...
import { Star, Video, ThumbsUp, Heart, CheckSquare } from "lucide-react";
import { Therapist } from "../page";
type InfoCardProps = {
  Data: Therapist;
};
function ProfileSections({ Data }: InfoCardProps) {
  const info =
      ...
      <Card className="border-none shadow-xl">
        ...
        <CardContent className="space-y-6">
          <p className="text-slate-600 leading-relaxed">
            Dr. Downey has practiced psychiatry for over 15 years, helping
            individuals manage emotional challenges through structured therapy,
